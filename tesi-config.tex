...
\renewcommand\lstlistlistingname{Esempi di codice}

\lstdefinelanguage{JavaScript}{
  morekeywords={typeof, new, true, false, catch, function, return, null, catch, switch, var, if, in, while, do, else, case, break, async, await, const, let},
...
\lstset{
    ...
    stringstyle=\color{Dandelion}\ttfamily,
    numbers=left,
