...
\begin{figure}[!ht]
  \begin{center}
    \includegraphics[scale=0.27]{screenshots/edi-user-dashboard.png}
...
\begin{figure}[!ht]
  \begin{center}
    \includegraphics[scale=0.25]{screenshots/attachments-list.png}
...
\begin{figure}[!ht]
  \begin{center}
    \includegraphics[scale=0.25]{screenshots/suppliers-list.png}
...
\begin{figure}[!ht]
  \begin{center}
    \includegraphics[scale=0.25]{screenshots/lago-grid-delete.png}
...
\begin{figure}[!ht]
  \begin{center}
    \includegraphics[scale=0.25]{screenshots/users-list.png}
