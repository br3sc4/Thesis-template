...
A questo punto il \emph{team} è pronto per iniziare lo \emph{sprint cycle}. \\
...
e viene calcolato il valore equivale in \emph{story points}; successivamente, il \emph{software} effettua il confronto con il valore pianificato in precedenza. In base all'esito del confronto il \emph{team} \
...
può calcolare i dati di \emph{code coverage} consentendo al \emph{team} di valutare la qualità del codice prodotto. \
