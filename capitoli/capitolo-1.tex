...
\subsubsection{\emph{\acrfull{mrs}}}
Le \emph{\acrlong{mrs}} vengono utilizzate per tracciare e revisionare i cambiamenti prima che essi vengano incorporati nei \emph{branch main} o \emph{develop}. All'interno del \
...
crea una \emph{\acrlong{mr}} e un \emph{feature branch}; una volta che il \emph{reviewer} ha approvato i cambiamenti implementati, il \emph{feature branch} viene unito al contenuto \
...
\vspace{20pt}
  \begin{figure}[!ht]
    \begin{center}
      ...
      \caption{Esempio di \emph{\acrlong{mr}}}
    \end{center}
  \end{figure}
\vspace{20pt} 
