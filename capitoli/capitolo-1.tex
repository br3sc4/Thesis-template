...
Prima iniziare uno \emph{sprint}, in Wavelop, durante lo \emph{Sprint Planning,} il \emph{team} si riunisce per definire l'obiettivo dello \emph{sprint} che si andrà a svolgere, inoltre vengono selezionate \
