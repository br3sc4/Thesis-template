...
Questo evento consente agli studenti di mettersi in gioco entrando in contatto con il mondo del lavoro e mettendo in pratica tutto ciò che hanno appreso durante il percoso di studi, metre le \
...
si che il mio inserimento nel \emph{team} sia avvenuto velocemente, instaurando sin da subito un rapporto un rapporto amichevole con i colleghi. Avendo svolto principalmente lo \
...
mio \emph{tutor} durante il periodo di \emph{stage}, con il quale ho svolto un colloquio conoscitivo, al termine del quale mi ha asseganto un test tecnico da svolgere su una piattaforma \
...
da tecnologie a me in gran parte sconosciute. Inoltre ha influito positivamente la forte propensione al \emph{remote working} da parte dell'azienda, ciò mi ha permesso di svolgere lo \emph{stage} \
