...
\begin{filecontents*}{\jobname.xmpdata}
  \Title{Sviluppo di Web App per la gestione degli ordini fornitore}
  \Author{Lorenzo Brescanzin}
  \Language{it-IT}
  \Subject{Il presente documento descrive il lavoro svolto durante il periodo di \emph{stage}, della durata di circa trecento ore, dal laureando Lorenzo Brescanzin presso l'azienda Wavelop SRLS.
  ...
  \Keywords{Fornitori\sep Ordini\sep Gestione\sep Web App}
\end{filecontents*}
...
\input{capitoli/capitolo-3}             % Implementazione del progetto
